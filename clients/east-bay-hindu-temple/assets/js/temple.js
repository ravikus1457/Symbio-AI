...
(function () {
  ...
  var DONATION = {
    ...
    // Zelle is registered to the temple's phone (see the temple's Zelle QR).
    zelle: "(925) 812-0581",
    zelleName: "Pandit Rakesh Bhargav Religious Services",
    venmo: "EastBayHinduTemple",
    // PayPal is scan-only: the temple's PayPal QR encodes an in-app code, not a
    // web link, so there's no tappable button — the QR below is the way to give.
    paypal: "",
